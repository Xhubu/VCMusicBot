...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("**Death:** ⏸ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("**Death:** ▶️ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("**Death:** ⏹ Stopped.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("**Death:** ⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("**Death:** ❇️ Admin cache refreshed!")
